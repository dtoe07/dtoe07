...
This is a static website that can be hosted in any simple server with just front end capability or locally.
...
2.  **Navigate to the project directory:**
    ...
    ```
3.  **Open `index.html`:**
    Locate and open the `index.html` file to load the website.

## Outside Libraries, Frameworks, and Resources
...
- **[WAVE Web Accessibility Evaluation Tool](https://wave.webaim.org/)**: Used to audit the website for accessibility issues.
